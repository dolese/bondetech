    ...
    <div style={styles.page}>
      <style>{`
        ...
        @media (max-width: 900px) {
          .landing-card { grid-template-columns: 1fr; min-height: 100vh; }
          .landing-left { padding: 42px 28px; }
          .landing-right { position: static; transform: none; width: 100%; max-width: 420px; margin: 32px auto 0; }
        }
      `}</style>
      <div style={styles.card} className="landing-card">
        ...
        <div style={styles.right} className="landing-right">
          <div>
