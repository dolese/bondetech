...
const DEFAULT_SLIDE_IMAGES = ["/asset/slider1.png", "/asset/slider2.png", "/asset/slider3.png"];
...
function sanitizeSlides(items, fallbackItems = []) {
  ...
  return source
    .map((item, index) => {
      const imageSrc = normalizeText(item?.imageSrc, DEFAULT_SLIDE_IMAGES[index] || DEFAULT_SLIDE_IMAGES[0], 255);
