...
const compareStudentsForCnoOrder = (left, right) => {
...
const syncFormCnosForClass = async (db, classId) => {
  ...
  allStudents.sort(compareStudentsForCnoOrder);
...
const reorderStudentsBySexAndRegenerateCnos = async (db, classId) => {
  return syncFormCnosForClass(db, classId);
};
